...
<div class="container">
    <div class="page-inner">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
            <div>
                <h3 class="fw-bold mb-3 pt-4">Featured List</h3>
            </div>
        </div>
        <hr>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-striped text-center align-middle">
                        ...
                        <tbody>
                            <?php
                            $count = 0;
                            $featured_product = isset($_POST["product_name"]) ? $_POST["product_name"] : "";
                            $query = "SELECT * FROM `tbl_feature` INNER JOIN tbl_product ON tbl_product.product_id = tbl_feature.product_id WHERE `product_name` LIKE '%$featured_product%'";
